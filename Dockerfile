...
# ============================================================================
# Build:
#   docker build -t dockerhub.kb.cz/pccm-sq016/ai-log-analyzer:r56 .
#
# Run:
#   docker run --env-file .env dockerhub.kb.cz/pccm-sq016/ai-log-analyzer:r56 python scripts/regular_phase.py
# ============================================================================
