...
ALGORITHM: IN-PLACE Peak Detection & Replacement
- Detekuj peak (porovnání s průměrem z 5 předchozích oken)
- Nahraď jeho hodnotu tímto průměrem
- Vlož nahrazenou hodnotu do DB
